...
<body>
	...
	<div class="containerTop">
		<img id="imageTopBrand"
			src="${pageContext.request.contextPath}/assets/images/LogoCerveau.jpg">
		<h1 id="TitreApp">SuperSchool</h1>
		<h2></h2>

		<a href="?lang=fr"><img id="drapeauFrance"
			src="${pageContext.request.contextPath}/assets/images/FlagFrance.png"></a>
		<a href="?lang=en"><img id="drapeauUK"
			src="${pageContext.request.contextPath}/assets/images/FlagUK.png"></a>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img
					src="${pageContext.request.contextPath}/assets/images/etablissement.jpg"
					class="d-block w-100" alt="..." height="800px">
				<div class="carousel-caption">
					<h5>Une école</h5>
					<small> un lieu d'apprentissage, un lieu de partage, un
						lieu de vie ... </small>
				</div>
			</div>
			<div class="carousel-item">
				<img
					src="${pageContext.request.contextPath}/assets/images/chapeau2.jpg"
					class="d-block w-100" alt="..." height="800px">
				<div class="carousel-caption">
					<h5>Un diplôme</h5>
					<small> un titre, un savoir-faire, un savoir-être ... </small>
				</div>
			</div>
			<div class="carousel-item">
				<img
					src="${pageContext.request.contextPath}/assets/images/salle-pause.jpg"
					class="d-block w-100" alt="..." height="800px">
				<div class="carousel-caption">
					<h5>Une vie</h5>
					<small> des pauses, des cafés et des bières ! </small>
				</div>
			</div>
		</div>
